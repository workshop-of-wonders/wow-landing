...
const { publishContent } = require('../_content');
...
module.exports = async function handler(req, res) {
  ...
  if (!GITHUB_TOKEN || !GITHUB_OWNER || !GITHUB_REPO) {
    console.error('content/publish.js: faltan GITHUB_TOKEN/GITHUB_OWNER/GITHUB_REPO');
  ...
  try {
    ...
    console.error('content/publish.js:', error);
